# NOVATEK — PCLand-style storefront pass
...
Changes:
- Added a proper storefront header with NOVATEK branding, search, language/account/cart controls and desktop navigation.
