...
export default function AIChat({ embedded = false }: { embedded?: boolean }) {
  ...
  const [messages, setMessages] = useState<{ role: "user" | "assistant"; text: string }[]>([
    { role: "assistant", text: "أهلاً! أنا مساعد NOVATEK 🤖 اسألني عن اللابتوبات، الخدمات الرقمية أو تصميم المواقع." },
  ]);
  ...
  if (embedded) {
    return (
      <div className="ai-chat-embedded" dir="rtl">
        <div className="ai-chat-head"><div><b>مساعد NOVATEK</b><small>المساعد الذكي</small></div></div>
      ...
      {open && (
        <div className="ai-chat-panel" dir="rtl">
          <div className="ai-chat-head">
            <div><b>مساعد NOVATEK</b><small>متصل الآن</small></div>
